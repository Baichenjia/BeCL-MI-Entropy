...
# bash
# nohup python MINE.py --algo cic_mi > logs/logs.txt 2>&1 &
# nohup python MINE.py --algo contrastive_mi_0.5 > logs/log1.txt 2>&1 &
# nohup python MINE.py --algo contrastive_mi_0.01 > logs/log1.txt 2>&1 &
# nohup python MINE.py --algo reverse_mi > logs/log2.txt 2>&1 &
# nohup python MINE.py --algo forward_mi > logs/log3.txt 2>&1 &
...
if __name__ == '__main__':
    ...
    result_indep = train(data1, data2, mine_net_indep, mine_net_optim)
    np.save(f"MI-result/MI-{algo}.npy", np.array(result_indep))
