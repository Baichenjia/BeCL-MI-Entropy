...
from base.modules.skill_discovery.cic_mi import Discriminator
from base.learners.skill_discovery.cic_mi import BaseCicMILearner


class CicMILearner(BaseCicMILearner):
    def create_env(self):
